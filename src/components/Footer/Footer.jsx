...
const Footer = () => {
    return (
        <footer className="mt-10 px-4 divide-y">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 md:flex-row md:space-y-0">
                <div className="md:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 md:justify-center">
                ...
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 md:w-2/3 md:grid-cols-3">
                    <div className="space-y-3">
                        ...
                        <ul className="space-y-1">
                            <li>
                                <a rel="noopener noreferrer" href="#">Sneaker</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#">Samba</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#">Stan Smith</a>
                            </li>
                            <li>
                    ...
                    <div className="space-y-3">
                        <h3 className="tracking-wide uppercase">Công ty</h3>
                        <ul className="space-y-1">
                            <li>
                                <a rel="noopener noreferrer" href="#">Chính sách</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#">Đội ngũ hỗ trợ</a>
                            </li>
                        </ul>
                    </div>
                    {/* <div className="space-y-3">
                    ...
                    <div className="space-y-3">
                        <div className="uppercase">Mạng xã hội</div>
